...
public class Walker {
	...
	public Walker(TextureAtlas atlas) {

		this.setSize(WIDTH, HEIGHT);
		this.setPosition(BaseScreen.VIEWPORT_WIDTH /2,
				BaseScreen.VIEWPORT_HEIGHT / 2);
		...
		DownWalking = regions[0];

		LeftWalking = regions[1];
		
		RightWalking = regions[2];
